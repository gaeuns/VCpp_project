...
{
    { {400, 250, 50, 25} },
    { {230, 350, 40, 25}, {300, 250, 40, 25}, {730, 450, 50, 25} },
    { {300, 350, 50, 25}, {200, 500, 50, 25}, {500, 350, 50, 25} }
};

std::vector<std::vector<Platform>> star =
{
    { {700, 220, 30, 30}, {110, 420, 30, 30}, {460, 30, 30, 30} },
    { {230, 80, 30, 30}, {780, 500, 30, 30} },
    { {80, 147, 30, 30}, {720, 120, 30, 30}, {420, 320, 30, 30}, {150, 470, 30, 30}, {750, 470, 30, 30} }
};
        ...
        if (IntersectRect(&intersection, &ballRect, &starRect))
        {
            ...
            if (star[currentRound].empty())
            {
                ...
                if (currentRound + 1 >= platforms.size())
                {
                    ...
                    isThread = false;
                    PostMessage(gWnd, WM_COMMAND, MAIN, NULL);
                    return;
                }
